            ...
            case LLM_ARCH_FALCON:
                {
                    ...
                    //share 
                    {
                        ...
                        ggml_context * ctx_split = ctx_for_layer_split(0);
                        layer.ffn_down = ml.create_tensor(ctx_split, tn(LLM_TENSOR_FFN_DOWN, "weight", 0), {  n_ff, n_embd});
                        layer.ffn_up   = ml.create_tensor(ctx_split, tn(LLM_TENSOR_FFN_UP,   "weight", 0), {n_embd,   n_ff});   
